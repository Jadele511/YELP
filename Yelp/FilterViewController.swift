...
class FilterViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, SwitchCellDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            ...
            case   0 :
                cell.longLabel.text = "Best Matched"
            case 1 :
                cell.longLabel.text = "Distance"
            default :
                 cell.longLabel.text = "High rated"
            }
    ...
    @IBAction func onSearchClick(sender: UIBarButtonItem) {
        ...
        var lastSelectedDouble = 0.0
        if (lastSelected?.row != nil) {
            lastSelectedDouble = self.distanceArray[(lastSelected?.row)!]
        }
        self.delegate?.filtersViewController(self, didUpdateFilters: selectedCategories, lastSelectedDistance: lastSelectedDouble)
    }
